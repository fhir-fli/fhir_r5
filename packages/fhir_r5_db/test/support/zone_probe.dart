...
Future<void> main() async {
  ...
  await count('birthdate-eq', fhir.R5ResourceType.Patient, {
    'birthdate': ['1990-01-15'],
  });
  await count('birthdate-day-before', fhir.R5ResourceType.Patient, {
    'birthdate': ['1990-01-14'],
  });
  await count('zoneless-eq', fhir.R5ResourceType.Observation, {
    'date': ['2013-01-14T10:00:00'],
  });
  await count('zoneless-day', fhir.R5ResourceType.Observation, {
    'date': ['2013-01-14'],
  });
  await count('zoned-eq', fhir.R5ResourceType.Observation, {
