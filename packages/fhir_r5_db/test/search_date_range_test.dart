...
Future<void> main() async {
  ...
  Future<List<String>> find(
    String value, {
    R5ResourceType type = R5ResourceType.Observation,
  ...
  test('a Period-valued parameter is indexed: Encounter.date', () async {
    ...
    expect(await find('2013-01', type: R5ResourceType.Encounter), ['enc']);
    expect(await find('2013-01-15', type: R5ResourceType.Encounter), isEmpty);
    expect(await find('ge2013-01-15', type: R5ResourceType.Encounter), ['enc']);
    expect(await find('le2013-01-15', type: R5ResourceType.Encounter), ['enc']);
    expect(await find('sa2013-01-13', type: R5ResourceType.Encounter), ['enc']);
    expect(await find('eb2013-01-17', type: R5ResourceType.Encounter), ['enc']);
    expect(await find('eb2013-01-16', type: R5ResourceType.Encounter), isEmpty);
  });
