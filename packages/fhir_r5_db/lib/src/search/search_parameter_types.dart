...
const Map<String, Map<String, SearchParameterDefinition>> searchParameterTypes =
  ...
  'Account': {
    ...
    'relatedaccount': SearchParameterDefinition('reference', []),
  ...
  'AdverseEvent': {
    ...
    'resultingeffect': SearchParameterDefinition('reference', []),
  ...
  'Condition': {
    ...
    'participant-actor': SearchParameterDefinition('reference', []),
    'participant-function': SearchParameterDefinition('token', []),
    'patient': SearchParameterDefinition('reference', []),
  ...
  'DocumentReference': {
    ...
    'format-canonical': SearchParameterDefinition('reference', []),
  ...
  'Observation': {
    ...
    'component-value-canonical': SearchParameterDefinition('uri', []),
    ...
    'value-date': SearchParameterDefinition(
        'date', ['eq', 'ne', 'gt', 'ge', 'lt', 'le', 'sa', 'eb', 'ap']),
    'value-markdown': SearchParameterDefinition('string', []),
  ...
  'TestPlan': {
    'identifier': SearchParameterDefinition('token', []),
    'scope': SearchParameterDefinition('reference', []),
    'status': SearchParameterDefinition('token', []),
    'url': SearchParameterDefinition('uri', []),
  },
  'TestReport': {
  ...
  'TestScript': {
    ...
    'name': SearchParameterDefinition('string', []),
    'publisher': SearchParameterDefinition('string', []),
    'scope-artifact': SearchParameterDefinition('reference', []),
    'status': SearchParameterDefinition('token', []),
