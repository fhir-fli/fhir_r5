...
class ConceptMapRelationshipBuilder extends FhirCodeEnumBuilder {
  ...
  factory ConceptMapRelationshipBuilder.fromJson(
    ...
    final known = _known(ConceptMapRelationshipBuilderEnum.fromString(value));
    return ConceptMapRelationshipBuilder._(
      valueString: value,
  ...
  static ConceptMapRelationshipBuilder? _known(
      ConceptMapRelationshipBuilderEnum? valueEnum) {
