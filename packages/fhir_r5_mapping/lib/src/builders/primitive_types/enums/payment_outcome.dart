...
class PaymentOutcomeBuilder extends FhirCodeEnumBuilder {
  ...
  factory PaymentOutcomeBuilder.fromJson(
    ...
    final known = _known(PaymentOutcomeBuilderEnum.fromString(value));
    return PaymentOutcomeBuilder._(
      valueString: value,
  ...
  static PaymentOutcomeBuilder? _known(PaymentOutcomeBuilderEnum? valueEnum) {
  ...
  static PaymentOutcomeBuilder queued = PaymentOutcomeBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/payment-outcome',
    ),
