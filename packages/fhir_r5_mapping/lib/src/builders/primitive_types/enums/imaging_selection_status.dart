...
class ImagingSelectionStatusBuilder extends FhirCodeEnumBuilder {
  ...
  factory ImagingSelectionStatusBuilder.fromJson(
    ...
    final known = _known(ImagingSelectionStatusBuilderEnum.fromString(value));
    return ImagingSelectionStatusBuilder._(
      valueString: value,
  ...
  static ImagingSelectionStatusBuilder? _known(
      ImagingSelectionStatusBuilderEnum? valueEnum) {
  ...
  static ImagingSelectionStatusBuilder available =
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/imagingselection-status',
    ),
