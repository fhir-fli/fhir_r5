...
class InventoryReportStatusBuilder extends FhirCodeEnumBuilder {
  ...
  factory InventoryReportStatusBuilder.fromJson(
    ...
    final known = _known(InventoryReportStatusBuilderEnum.fromString(value));
    return InventoryReportStatusBuilder._(
      valueString: value,
  ...
  static InventoryReportStatusBuilder? _known(
      InventoryReportStatusBuilderEnum? valueEnum) {
