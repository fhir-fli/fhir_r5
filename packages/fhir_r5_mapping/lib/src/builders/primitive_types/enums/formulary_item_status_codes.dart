...
class FormularyItemStatusCodesBuilder extends FhirCodeEnumBuilder {
  ...
  factory FormularyItemStatusCodesBuilder.fromJson(
    ...
    final known = _known(FormularyItemStatusCodesBuilderEnum.fromString(value));
    return FormularyItemStatusCodesBuilder._(
      valueString: value,
  ...
  static FormularyItemStatusCodesBuilder? _known(
      FormularyItemStatusCodesBuilderEnum? valueEnum) {
  ...
  static FormularyItemStatusCodesBuilder active =
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/CodeSystem/formularyitem-status',
    ),
