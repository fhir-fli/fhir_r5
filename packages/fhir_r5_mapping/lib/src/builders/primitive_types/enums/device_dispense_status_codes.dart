...
class DeviceDispenseStatusCodesBuilder extends FhirCodeEnumBuilder {
  ...
  factory DeviceDispenseStatusCodesBuilder.fromJson(
    ...
    final known =
        _known(DeviceDispenseStatusCodesBuilderEnum.fromString(value));
    return DeviceDispenseStatusCodesBuilder._(
      valueString: value,
  ...
  static DeviceDispenseStatusCodesBuilder? _known(
      DeviceDispenseStatusCodesBuilderEnum? valueEnum) {
