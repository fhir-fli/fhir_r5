...
class QuestionnaireItemDisabledDisplayBuilder extends FhirCodeEnumBuilder {
  ...
  factory QuestionnaireItemDisabledDisplayBuilder.fromJson(
    ...
    final known =
        _known(QuestionnaireItemDisabledDisplayBuilderEnum.fromString(value));
    return QuestionnaireItemDisabledDisplayBuilder._(
      valueString: value,
  ...
  static QuestionnaireItemDisabledDisplayBuilder? _known(
      QuestionnaireItemDisabledDisplayBuilderEnum? valueEnum) {
  ...
  static QuestionnaireItemDisabledDisplayBuilder hidden =
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/questionnaire-disabled-display',
    ),
