...
class TransportStatusBuilder extends FhirCodeEnumBuilder {
  ...
  factory TransportStatusBuilder.fromJson(
    ...
    final known = _known(TransportStatusBuilderEnum.fromString(value));
    return TransportStatusBuilder._(
      valueString: value,
  ...
  static TransportStatusBuilder? _known(TransportStatusBuilderEnum? valueEnum) {
  ...
  static TransportStatusBuilder inProgress = TransportStatusBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/transport-status',
    ),
