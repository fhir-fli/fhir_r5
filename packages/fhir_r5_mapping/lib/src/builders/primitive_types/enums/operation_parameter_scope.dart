...
class OperationParameterScopeBuilder extends FhirCodeEnumBuilder {
  ...
  factory OperationParameterScopeBuilder.fromJson(
    ...
    final known = _known(OperationParameterScopeBuilderEnum.fromString(value));
    return OperationParameterScopeBuilder._(
      valueString: value,
  ...
  static OperationParameterScopeBuilder? _known(
      OperationParameterScopeBuilderEnum? valueEnum) {
  ...
  static OperationParameterScopeBuilder instance =
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/operation-parameter-scope',
    ),
