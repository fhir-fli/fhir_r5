...
class VerificationResultStatusBuilder extends FhirCodeEnumBuilder {
  ...
  factory VerificationResultStatusBuilder.fromJson(
    ...
    final known = _known(VerificationResultStatusBuilderEnum.fromString(value));
    return VerificationResultStatusBuilder._(
      valueString: value,
  ...
  static VerificationResultStatusBuilder? _known(
      VerificationResultStatusBuilderEnum? valueEnum) {
