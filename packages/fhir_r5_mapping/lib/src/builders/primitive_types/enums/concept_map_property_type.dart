...
class ConceptMapPropertyTypeBuilder extends FhirCodeEnumBuilder {
  ...
  factory ConceptMapPropertyTypeBuilder.fromJson(
    ...
    final known = _known(ConceptMapPropertyTypeBuilderEnum.fromString(value));
    return ConceptMapPropertyTypeBuilder._(
      valueString: value,
  ...
  static ConceptMapPropertyTypeBuilder? _known(
      ConceptMapPropertyTypeBuilderEnum? valueEnum) {
  ...
  static ConceptMapPropertyTypeBuilder coding = ConceptMapPropertyTypeBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/conceptmap-property-type',
    ),
