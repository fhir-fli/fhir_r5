...
class BiologicallyDerivedProductDispenseCodesBuilder
  ...
  factory BiologicallyDerivedProductDispenseCodesBuilder.fromJson(
    ...
    final known = _known(
        BiologicallyDerivedProductDispenseCodesBuilderEnum.fromString(value));
    return BiologicallyDerivedProductDispenseCodesBuilder._(
      valueString: value,
  ...
  static BiologicallyDerivedProductDispenseCodesBuilder? _known(
      BiologicallyDerivedProductDispenseCodesBuilderEnum? valueEnum) {
