...
class PermissionStatusBuilder extends FhirCodeEnumBuilder {
  ...
  factory PermissionStatusBuilder.fromJson(
    ...
    final known = _known(PermissionStatusBuilderEnum.fromString(value));
    return PermissionStatusBuilder._(
      valueString: value,
  ...
  static PermissionStatusBuilder? _known(
      PermissionStatusBuilderEnum? valueEnum) {
  ...
  static PermissionStatusBuilder active = PermissionStatusBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/permission-status',
    ),
