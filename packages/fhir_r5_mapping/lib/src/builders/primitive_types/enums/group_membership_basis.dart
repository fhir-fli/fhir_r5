...
class GroupMembershipBasisBuilder extends FhirCodeEnumBuilder {
  ...
  factory GroupMembershipBasisBuilder.fromJson(
    ...
    final known = _known(GroupMembershipBasisBuilderEnum.fromString(value));
    return GroupMembershipBasisBuilder._(
      valueString: value,
  ...
  static GroupMembershipBasisBuilder? _known(
      GroupMembershipBasisBuilderEnum? valueEnum) {
  ...
  static GroupMembershipBasisBuilder definitional =
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/group-membership-basis',
    ),
