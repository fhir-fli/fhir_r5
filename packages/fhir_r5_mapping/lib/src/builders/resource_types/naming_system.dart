...
class NamingSystemBuilder extends MetadataResourceBuilder {
  ...
  NamingSystemBuilder({
    ...
    this.identifier,
    super.version,
    VersionAlgorithmXNamingSystemBuilder? versionAlgorithmX,
  ...
  factory NamingSystemBuilder.fromJson(
    ...
    return NamingSystemBuilder(
      ...
      versionAlgorithmX:
          JsonParser.parsePolymorphic<VersionAlgorithmXNamingSystemBuilder>(
        json,
        {
  ...
  void setChildByName(String childName, dynamic child) {
    ...
    switch (childName) {
      ...
      case 'versionAlgorithmX':
        {
          if (child is VersionAlgorithmXNamingSystemBuilder) {
...
class NamingSystemUniqueIdBuilder extends BackboneElementBuilder {
  ...
  factory NamingSystemUniqueIdBuilder.fromJson(
    ...
    return NamingSystemUniqueIdBuilder(
      ...
      authoritative: JsonParser.parsePrimitive<FhirBooleanBuilder>(
        json,
        'authoritative',
        FhirBooleanBuilder.fromJson,
        '$objectPath.authoritative',
      ),
    );
  }
  ...
  FhirBooleanBuilder? authoritative;
  ...
  Map<String, dynamic> toJson() {
    ...
    addField('authoritative', authoritative);
    return json;
  }
  ...
  void createProperty(String propertyName) {
    switch (propertyName) {
      ...
      case 'authoritative':
        {
          authoritative = FhirBooleanBuilder.empty();
          return;
        }
      default:
        throw ArgumentError('No matching property: $propertyName');
