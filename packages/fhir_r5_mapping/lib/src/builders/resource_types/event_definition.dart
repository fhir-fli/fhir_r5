...
class EventDefinitionBuilder extends MetadataResourceBuilder {
  ...
  EventDefinitionBuilder({
    ...
    this.identifier,
    super.version,
    VersionAlgorithmXEventDefinitionBuilder? versionAlgorithmX,
  ...
  factory EventDefinitionBuilder.fromJson(
    ...
    return EventDefinitionBuilder(
      ...
      versionAlgorithmX:
          JsonParser.parsePolymorphic<VersionAlgorithmXEventDefinitionBuilder>(
        json,
        {
  ...
  void setChildByName(String childName, dynamic child) {
    ...
    switch (childName) {
      ...
      case 'versionAlgorithmX':
        {
          if (child is VersionAlgorithmXEventDefinitionBuilder) {
