...
class CompartmentDefinitionBuilder extends CanonicalResourceBuilder {
  ...
  CompartmentDefinitionBuilder({
    ...
    super.url,
    super.version,
    VersionAlgorithmXCompartmentDefinitionBuilder? versionAlgorithmX,
  ...
  void setChildByName(String childName, dynamic child) {
    ...
    switch (childName) {
      ...
      case 'versionAlgorithmX':
        {
          if (child is VersionAlgorithmXCompartmentDefinitionBuilder) {
...
class CompartmentDefinitionResourceBuilder extends BackboneElementBuilder {
  ...
  factory CompartmentDefinitionResourceBuilder.fromJson(
    ...
    return CompartmentDefinitionResourceBuilder(
      ...
      startParam: JsonParser.parsePrimitive<FhirUriBuilder>(
        json,
        'startParam',
        FhirUriBuilder.fromJson,
        '$objectPath.startParam',
      ),
      endParam: JsonParser.parsePrimitive<FhirUriBuilder>(
        json,
        'endParam',
        FhirUriBuilder.fromJson,
        '$objectPath.endParam',
  ...
  Map<String, dynamic> toJson() {
    ...
    addField('startParam', startParam);
    addField('endParam', endParam);
    return json;
  }
  ...
  void createProperty(String propertyName) {
    switch (propertyName) {
      ...
      case 'startParam':
        {
          startParam = FhirUriBuilder.empty();
          return;
        }
      case 'endParam':
        {
          endParam = FhirUriBuilder.empty();
          return;
        }
      default:
        throw ArgumentError('No matching property: $propertyName');
  ...
  CompartmentDefinitionResourceBuilder copyWith({
    ...
    final newResult = CompartmentDefinitionResourceBuilder(
      ...
      startParam: startParam ?? this.startParam,
      endParam: endParam ?? this.endParam,
    )..objectPath = newObjectPath;
    // Copy user data and annotations
    if (userData != null) {
      newResult.userData = userData;
