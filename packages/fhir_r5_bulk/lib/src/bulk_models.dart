...
class BulkExportKickoff {
  ...
  /// The `_type` values that are not R5 resource type names.
  List<String> get unknownTypes =>
      types.where((t) => R5ResourceType.fromString(t) == null).toList();
...
class TypeFilter {
  ...
  /// Whether [resourceType] is an R5 resource type name.
  bool get resourceTypeKnown => R5ResourceType.fromString(resourceType) != null;
