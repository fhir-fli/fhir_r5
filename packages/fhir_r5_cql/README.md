...
A Dart implementation of the [Clinical Quality Language (CQL)](https://cql.hl7.org/) for FHIR R5. This package parses CQL source text into an Expression Logic Model (ELM) representation and provides an execution engine to evaluate CQL expressions against FHIR data.
