...
/// FHIR R5 [TerminologyProvider]: resolves value-set membership by fetching
/// the FHIR `ValueSet` resource from a [CanonicalResourceCache] and checking
/// it with `fhir_r5_path`'s [ValueSetChecker].
///
...
/// imports `fhir_r5` / `fhir_r5_path`; that coupling lives here.
class R5TerminologyProvider implements TerminologyProvider {
