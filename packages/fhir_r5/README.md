...
A Dart implementation of the FHIR (Fast Healthcare Interoperability Resources) R5 specification. This package provides FHIR R5 resource models and utilities for serialization/deserialization, working with primitive types, polymorphic fields, and more.
...
- **Complete FHIR R5 Resource Models**: Fully-typed Dart classes for all FHIR R5 resources generated from the official specification
