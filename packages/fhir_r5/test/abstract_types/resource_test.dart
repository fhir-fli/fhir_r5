  ...
  group('Resource', () {
    group('fromJson', () {
      test('parses a Patient from JSON map', () {
        ...
        expect(resource.resourceType, R5ResourceType.Patient);
    ...
    group('resourceType accessor', () {
      test('returns correct R5ResourceType for Patient', () {
        final patient = Patient(
          id: 'p1'.toFhirString,
          active: FhirBoolean(true),
        );
        expect(patient.resourceType, R5ResourceType.Patient);
      });

      test('returns correct R5ResourceType for Organization', () {
        final org = Organization(id: 'org1'.toFhirString);
        expect(org.resourceType, R5ResourceType.Organization);
      });
    });
...
''';
    ...
    group('resourceTypeFromString', () {
      test('returns R5ResourceType for valid string', () {
        final type = Resource.resourceTypeFromString('Patient');
        expect(type, R5ResourceType.Patient);
      });
