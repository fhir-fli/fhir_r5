  ...
  String toString() {
    switch (this) {
      ...
      case ProvenanceEntityRoleEnum.source:
        return 'source';
      case ProvenanceEntityRoleEnum.instantiates:
        return 'instantiates';
...
class ProvenanceEntityRole extends FhirCodeEnum {
  ...
  /// instantiates
  static const ProvenanceEntityRole instantiates = ProvenanceEntityRole._(
    valueString: 'instantiates',
    valueEnum: ProvenanceEntityRoleEnum.instantiates,
    system: FhirUri._(
      valueString: 'http://hl7.org/fhir/ValueSet/provenance-entity-role',
    ),
    version: FhirString._(valueString: '5.0.0'),
