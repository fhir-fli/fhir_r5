...
class PlanDefinition extends MetadataResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<PlanDefinitionActor>(
      actor,
      o.actor,
    )) {
      return false;
...
class PlanDefinitionActor extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<PlanDefinitionOption>(
      option,
      o.option,
    )) {
      return false;
...
class PlanDefinitionAction extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<PlanDefinitionInput>(
      input,
      o.input,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<PlanDefinitionOutput>(
      output,
      o.output,
    )) {
      return false;
