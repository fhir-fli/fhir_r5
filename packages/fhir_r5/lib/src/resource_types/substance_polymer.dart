...
class SubstancePolymer extends DomainResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<SubstancePolymerMonomerSet>(
      monomerSet,
      o.monomerSet,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<SubstancePolymerRepeat>(
      repeat,
      o.repeat,
    )) {
      return false;
...
class SubstancePolymerMonomerSet extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<SubstancePolymerStartingMaterial>(
      startingMaterial,
      o.startingMaterial,
    )) {
      return false;
...
class SubstancePolymerRepeat extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<SubstancePolymerRepeatUnit>(
      repeatUnit,
      o.repeatUnit,
    )) {
      return false;
...
class SubstancePolymerRepeatUnit extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<SubstancePolymerDegreeOfPolymerisation>(
      degreeOfPolymerisation,
      o.degreeOfPolymerisation,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<SubstancePolymerStructuralRepresentation>(
      structuralRepresentation,
