...
class ConditionDefinition extends MetadataResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<ConditionDefinitionObservation>(
      observation,
      o.observation,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<ConditionDefinitionMedication>(
      medication,
      o.medication,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<ConditionDefinitionPrecondition>(
      precondition,
      o.precondition,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<ConditionDefinitionQuestionnaire>(
      questionnaire,
      o.questionnaire,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<ConditionDefinitionPlan>(
      plan,
      o.plan,
    )) {
      return false;
