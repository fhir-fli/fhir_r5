...
class NutritionIntake extends DomainResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<NutritionIntakeConsumedItem>(
      consumedItem,
      o.consumedItem,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<NutritionIntakeIngredientLabel>(
      ingredientLabel,
      o.ingredientLabel,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<NutritionIntakePerformer>(
      performer,
      o.performer,
    )) {
      return false;
