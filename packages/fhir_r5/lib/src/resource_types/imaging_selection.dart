...
class ImagingSelection extends DomainResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<ImagingSelectionPerformer>(
      performer,
      o.performer,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<ImagingSelectionInstance>(
      instance,
      o.instance,
    )) {
      return false;
...
class ImagingSelectionInstance extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<ImagingSelectionImageRegion2D>(
      imageRegion2D,
      o.imageRegion2D,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<ImagingSelectionImageRegion3D>(
      imageRegion3D,
      o.imageRegion3D,
    )) {
      return false;
