...
class InventoryItem extends DomainResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<InventoryItemName>(
      name,
      o.name,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<InventoryItemResponsibleOrganization>(
      responsibleOrganization,
    ...
    if (!FhirBase.listEquals<InventoryItemAssociation>(
      association,
      o.association,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<InventoryItemCharacteristic>(
      characteristic,
      o.characteristic,
    )) {
      return false;
