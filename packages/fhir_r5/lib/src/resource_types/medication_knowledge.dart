...
class MedicationKnowledge extends DomainResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<MedicationKnowledgeIndicationGuideline>(
      indicationGuideline,
    ...
    if (!FhirBase.listEquals<MedicationKnowledgePackaging>(
      packaging,
      o.packaging,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<MedicationKnowledgeStorageGuideline>(
      storageGuideline,
      o.storageGuideline,
    )) {
      return false;
...
class MedicationKnowledgeIndicationGuideline extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<MedicationKnowledgeDosingGuideline>(
      dosingGuideline,
      o.dosingGuideline,
    )) {
      return false;
...
class MedicationKnowledgeDosingGuideline extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<MedicationKnowledgePatientCharacteristic>(
      patientCharacteristic,
...
class MedicationKnowledgeStorageGuideline extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<MedicationKnowledgeEnvironmentalSetting>(
      environmentalSetting,
