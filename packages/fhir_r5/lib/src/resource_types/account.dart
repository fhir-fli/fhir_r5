...
class Account extends DomainResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<AccountDiagnosis>(
      diagnosis,
      o.diagnosis,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<AccountProcedure>(
      procedure,
      o.procedure,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<AccountRelatedAccount>(
      relatedAccount,
      o.relatedAccount,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<AccountBalance>(
      balance,
      o.balance,
    )) {
      return false;
