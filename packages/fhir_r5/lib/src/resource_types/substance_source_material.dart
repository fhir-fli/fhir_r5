...
class SubstanceSourceMaterial extends DomainResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<SubstanceSourceMaterialFractionDescription>(
      fractionDescription,
    ...
    if (!FhirBase.listEquals<SubstanceSourceMaterialPartDescription>(
      partDescription,
      o.partDescription,
    )) {
      return false;
...
class SubstanceSourceMaterialOrganism extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<SubstanceSourceMaterialAuthor>(
      author,
      o.author,
    )) {
      return false;
