...
class TestPlan extends CanonicalResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<TestPlanDependency>(
      dependency,
      o.dependency,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<TestPlanTestCase>(
      testCase,
      o.testCase,
    )) {
      return false;
...
class TestPlanTestCase extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<TestPlanTestRun>(
      testRun,
      o.testRun,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<TestPlanTestData>(
      testData,
      o.testData,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<TestPlanAssertion>(
      assertion,
      o.assertion,
    )) {
      return false;
