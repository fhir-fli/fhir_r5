...
class ChargeItemDefinition extends MetadataResource {
  ...
  factory ChargeItemDefinition.fromJson(
    ...
    return ChargeItemDefinition(
      ...
      versionAlgorithmX:
          JsonParser.parsePolymorphic<VersionAlgorithmXChargeItemDefinition>(
        json,
        {
  ...
  /// more current.
  final VersionAlgorithmXChargeItemDefinition? versionAlgorithmX;
...
class ChargeItemDefinitionApplicability extends BackboneElement {
  ...
  factory ChargeItemDefinitionApplicability.fromJson(
    ...
    return ChargeItemDefinitionApplicability(
      ...
      relatedArtifact: JsonParser.parseObject<RelatedArtifact>(
        json,
        'relatedArtifact',
...
class ChargeItemDefinitionPropertyGroup extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<MonetaryComponent>(
      priceComponent,
      o.priceComponent,
    )) {
      return false;
