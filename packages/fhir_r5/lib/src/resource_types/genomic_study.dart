...
class GenomicStudy extends DomainResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<GenomicStudyAnalysis>(
      analysis,
      o.analysis,
    )) {
      return false;
...
class GenomicStudyAnalysis extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<GenomicStudyInput>(
      input,
      o.input,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<GenomicStudyOutput>(
      output,
      o.output,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<GenomicStudyPerformer>(
      performer,
      o.performer,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<GenomicStudyDevice>(
      device,
      o.device,
    )) {
      return false;
