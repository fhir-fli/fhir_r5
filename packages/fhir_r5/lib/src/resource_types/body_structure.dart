...
class BodyStructure extends DomainResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<BodyStructureIncludedStructure>(
      includedStructure,
      o.includedStructure,
    )) {
      return false;
...
class BodyStructureIncludedStructure extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<BodyStructureBodyLandmarkOrientation>(
      bodyLandmarkOrientation,
...
class BodyStructureBodyLandmarkOrientation extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<BodyStructureDistanceFromLandmark>(
      distanceFromLandmark,
