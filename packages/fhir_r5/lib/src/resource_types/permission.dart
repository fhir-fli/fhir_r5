...
class Permission extends DomainResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<PermissionRule>(
      rule,
      o.rule,
    )) {
      return false;
...
class PermissionRule extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<PermissionData>(
      data,
      o.data,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<PermissionActivity>(
      activity,
      o.activity,
    )) {
      return false;
...
class PermissionData extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<PermissionResource>(
      resource,
      o.resource,
    )) {
      return false;
