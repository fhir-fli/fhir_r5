...
Future<void> testOfficialGaps() async {
  ...
  group('official-testInheritance', () {
    ...
    // but the Java reference only enforces that rule for R5+ (its R5
    // engine sets doNotEnforceAsSingletonRule); our R5 binding matches the
    // reference's R5 leniency, so there is no error to assert.
