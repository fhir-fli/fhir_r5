...
A Dart package implementing [CDS Hooks 2.0](https://cds-hooks.hl7.org/2.0/) for FHIR R5. Provides model classes, a client for invoking remote CDS services, and utilities for building service responses.
...
```dart
import 'package:fhir_r5_cds_hooks/fhir_r5_cds_hooks.dart';
...
final request = CdsRequest(
  ...
  fhirServer: 'https://fhir.example.com/r5',
);
...
final resolver = PrefetchResolver(
  fhirServerUrl: 'https://fhir.example.com/r5',
...
- Part of the [fhir_r5](https://pub.dev/packages/fhir_r5) package family
...
- Repository: [github.com/fhir-fli/fhir_r5](https://github.com/fhir-fli/fhir_r5)
