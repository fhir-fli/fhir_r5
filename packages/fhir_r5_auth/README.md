...
[![pub package](https://img.shields.io/pub/v/fhir_r5_auth.svg)](https://pub.dev/packages/fhir_r5_auth)
...
final client = SmartFhirClient(
  config: SmartConfig(
    ...
    fhirBaseUrl: 'https://fhir.example.com/r5'.toFhirUri,
...
//    or hand it to fhir_r5_at_rest to build typed FHIR requests:
...
- 🎯 [API Reference](https://pub.dev/documentation/fhir_r5_auth/latest/)
- 💡 [Examples](https://github.com/fhirfli/fhir_r5_auth/tree/main/example)
...
- 🐛 [Report Issues](https://github.com/fhirfli/fhir_r5_auth/issues)
- 💬 [Discussions](https://github.com/fhirfli/fhir_r5_auth/discussions)
